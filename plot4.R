...
plot(electric$Time,electric$Voltage,type="l", xlab="datetime", ylab="Voltage")
...
plot(electric$Time,electric$Global_reactive_power,type="l", xlab="datetime", ylab="Global_reactive_power")
dev.off()